...
function createGuessYouLike(data) {
    ...
    switch (n) {
        case 1:
            data['result'] = data.id % 2 === 0 ? '《Executing Magic》' : '《Element Of Robotics》'
            break
        case 2:
            data['result'] = data.id % 2 === 0 ? '《Science》' : '《PhotoGraphy》'
            break
        case 3:
            data['result'] = data.id % 2 === 0 ? '《Sports》' : '《Meals》'
            data['percent'] = data.id % 2 === 0 ? '92%' : '96%'
            break
    }
    return data
}
